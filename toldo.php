...
if ($resultado_toldos->rowCount() > 0) {
    while ($row_toldos = $resultado_toldos->fetch(PDO::FETCH_ASSOC)) {
        ...
        if($query_type_run->rowCount() > 0){
            foreach ($query_type_run as $row_type) {
                ...
                if ($row_type['reservation_type'] == 'passante') {
                    if ($toldoNumber == '18' || $toldoNumber == '35' || $toldoNumber == '49' || $toldoNumber == '63' || $toldoNumber == '77'){
                        echo "<a href='toldoocupado.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo' style='background-color:red;'>".$toldoNumber."</div></a></div><div class='row' style='display: flex; flex-wrap: wrap;'>";
                    }else{
                    echo "<a href='toldoocupado.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo' style='background-color:red;'>".$toldoNumber."</div></a>";
                    }    
                } elseif ($row_type['reservation_type'] == 'hotel') {
                    if ($toldoNumber == '18' || $toldoNumber == '35' || $toldoNumber == '49' || $toldoNumber == '63' || $toldoNumber == '77'){
                        echo "<a href='toldoocupado.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo $id_toldo' onclick='handleToldoClick(event)' style='background-color:blue;'>".$toldoNumber."</div></a></div><div class='row' style='display: flex; flex-wrap: wrap;'>";
                    }else{
                    echo "<a href='toldoocupado.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo $id_toldo' onclick='handleToldoClick(event)' style='background-color:blue;'>".$toldoNumber."</div></a>";
                    }    
                } 
            }
        }else { 
            ...
            if ($toldoNumber == '18' || $toldoNumber == '35' || $toldoNumber == '49' || $toldoNumber == '63' || $toldoNumber == '77'){
                echo "<a href='toldoreserva.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo $id_toldo' onclick='handleToldoClick(event)'>".$toldoNumber."</div></a></div><div class='row' style='display: flex; flex-wrap: wrap;'>";
            }else{
            echo "<a href='toldoreserva.php?toldoId=".$id_toldo."' style='text-decoration:none;color:black;'><div class='toldo $id_toldo' onclick='handleToldoClick(event)'>".$toldoNumber."</div></a>";
            }
        }
    }
}
...
?>
                <br><br>
                <form action="toldo.php" method="POST">
                <div class="button-container" style="display: flex; justify-content: right; margin-right: 110px;">
                    <a class="button" style="text-decoration: none; color: #222222; margin-right: 20px;" href="toldoDis.php">Disponível</a>
    ...
    <script>
        ...
        function handleToldoClick(event) {
            ...
            if (isOcupado) {
                window.location.href = 'toldoocupado.php?toldo_id=' + toldoId;
            } else {
                window.location.href = 'toldoreserva.php?toldo_id=' + toldoId;
            }
        }
